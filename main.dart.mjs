...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      BK: (x0,x1) => ({frameIndex: x0,completeFramesOnly: x1}),
      ...
      HK: () => globalThis.window.ImageDecoder,
      HL: x0 => x0.repeat,
      ...
      JJ: (x0,x1,x2) => ({amount: x0,memo: x1,metadata: x2}),
      JK: x0 => x0.response,
      JL: x0 => x0.userAgent,
      K: (exn) => {
      ...
      KK: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      KL: x0 => x0.navigator,
      L: o => o === undefined,
      ...
      OJ: (x0,x1,x2,x3) => ({onReadyForServerApproval: x0,onReadyForServerCompletion: x1,onCancel: x2,onError: x3}),
      OK: x0 => x0.localStorage,
      OL: x0 => x0.getReader(),
      ...
      PJ: (x0,x1,x2) => x0.createPayment(x1,x2),
      PK: () => globalThis.window,
      PL: x0 => x0.value,
      ...
      TK: x0 => x0.location,
      TL: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      dJ: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      gI: (o, t) => typeof o === t,
      gJ: (x0,x1) => x0.revokeObjectURL(x1),
      gK: x0 => x0.disabled,
      ...
      iH: x0 => x0.Segmenter,
      iI: x0 => x0.network,
      iJ: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      iK: (x0,x1) => { x0.max = x1 },
      j: x0 => x0.random(),
      ...
      nI: x0 => x0.amount,
      nJ: (x0,x1) => { x0.crossOrigin = x1 },
      nK: (x0,x1) => x0.transferFromImageBitmap(x1),
      ...
      oI: x0 => x0.user_uid,
      oJ: (x0,x1) => x0.createObjectURL(x1),
      ...
      wK: x0 => x0.canvasKitMaximumSurfaces,

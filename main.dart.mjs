...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      jK: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      mI: x0 => x0.memo,
      mJ: x0 => x0.tracks,
      mK: (x0,x1) => x0.readAsArrayBuffer(x1),

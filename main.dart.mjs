...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      DK: x0 => x0.name,
      DL: x0 => x0.videoWidth,
      DM: x0 => x0.rasterEndMilliseconds,
      E: (exn) => {
      ...
      EL: x0 => x0.readyState,
      EM: x0 => x0.rasterStartMilliseconds,
      F: () => new Error().stack,
      ...
      GM: x0 => x0.canvasKitMaximumSurfaces,
      ...
      HK: x0 => x0.completed,
      HL: (x0,x1) => { x0.onloadeddata = x1 },
      HM: x0 => x0.nextSibling,
      ...
      LM: (x0,x1) => x0.getModifierState(x1),
      M: o => String(o),
      MB: (o, p) => o[p],
      ...
      VJ: (x0,x1) => { x0.backgroundColor = x1 },
      VK: (x0,x1,x2) => x0.addEventListener(x1,x2),
      VL: () => new FileReader(),
      VM: (x0,x1) => x0.key(x1),
      W: x0 => new Array(x0),
      ...
      bL: x0 => x0.type,
      bM: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      c: o => o,
      cB: o => {
        if (o === null || o === undefined) return 0;
      ...
      cH: x0 => x0.value,
      cI: x0 => x0.status,
      cJ: (x0,x1) => { x0.muted = x1 },
      cK: () => new XMLHttpRequest(),
      cL: x0 => x0.result,
      cM: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      d: (o, p) => o[p],
      ...
      dI: x0 => x0.getReader(),
      dJ: (x0,x1) => { x0.src = x1 },
      dK: (x0,x1,x2) => ({amount: x0,memo: x1,metadata: x2}),
      dL: x0 => x0.length,
      dM: x0 => x0.message,
      e: () => globalThis,
      eB: o => {
      ...
      fK: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1) { return wasmFunction(f,arguments.length,x0,x1) }),
      fL: (x0,x1) => { x0.display = x1 },
      fM: x0 => x0.speed,
      ...
      iK: (x0,x1,x2,x3) => ({onReadyForServerApproval: x0,onReadyForServerCompletion: x1,onCancel: x2,onError: x3}),
      iL: (x0,x1) => { x0.draggable = x1 },
      iM: x0 => x0.altitudeAccuracy,
      j: x0 => x0.random(),
      ...
      jK: (x0,x1,x2) => x0.createPayment(x1,x2),
      jL: (x0,x1) => { x0.type = x1 },
      jM: x0 => x0.altitude,
      k: o => o,
      kB: o => {
      ...
      mL: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      mM: x0 => x0.latitude,
      ...
      xK: (x0,x1,x2) => x0.toDataURL(x1,x2),
      xL: (x0,x1) => x0.transferFromImageBitmap(x1),
      xM: (x0,x1) => new OffscreenCanvas(x0,x1),

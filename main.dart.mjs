...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AH: x0 => x0.unlock(),
      AI: (x0,x1) => { x0.max = x1 },
      AJ: (x0,x1) => ({version: x0,sandbox: x1}),
      AK: (x0,x1) => { x0.overflow = x1 },
      AL: () => globalThis.window.ImageDecoder,
      AM: () => globalThis.window,
      ...
      CM: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      CN: x0 => x0.navigator,
      ...
      DJ: (x0,x1) => new WebSocket(x0,x1),
      DK: (x0,x1) => { x0.backgroundColor = x1 },
      ...
      EJ: x0 => x0.reason,
      EK: (x0,x1) => { x0.objectFit = x1 },
      EL: (x0,x1,x2) => x0.addEventListener(x1,x2),
      EM: () => new FileReader(),
      EN: x0 => x0.length,
      F: () => new Error().stack,
      ...
      FM: (x0,x1) => x0.readAsArrayBuffer(x1),
      FN: (x0,x1) => x0.query(x1),
      ...
      JI: (map, o) => map.get(o),
      JJ: x0 => x0.data,
      JK: (x0,x1) => { x0.preload = x1 },
      JL: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      JM: x0 => x0.name,
      JN: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      K: (exn) => {
      ...
      KK: (x0,x1) => { x0.playsInline = x1 },
      KL: (x0,x1) => { x0.responseType = x1 },
      KM: x0 => x0.type,
      KN: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      L: o => o === undefined,
      ...
      LJ: (x0,x1,x2) => x0.close(x1,x2),
      LK: (x0,x1) => { x0.autoplay = x1 },
      LL: () => new XMLHttpRequest(),
      LM: x0 => x0.result,
      LN: x0 => x0.message,
      M: o => String(o),
      MB: (o, p) => o[p],
      ...
      MI: x0 => x0.deref(),
      MJ: (x0,x1) => x0.close(x1),
      MK: (x0,x1) => { x0.loop = x1 },
      ML: (x0,x1) => { x0.visibility = x1 },
      MM: x0 => x0.length,
      MN: x0 => x0.code,
      N: (c) =>
      ...
      NJ: x0 => x0.close(),
      NK: (x0,x1) => { x0.muted = x1 },
      NL: (x0,x1,x2) => ({amount: x0,memo: x1,metadata: x2}),
      NM: x0 => x0.files,
      NN: x0 => x0.speed,
      ...
      QM: (x0,x1) => { x0.draggable = x1 },
      QN: x0 => x0.altitudeAccuracy,
      ...
      SJ: x0 => x0.parentElement,
      SK: (x0,x1) => { x0.pointerEvents = x1 },
      SL: (x0,x1,x2,x3) => ({onReadyForServerApproval: x0,onReadyForServerCompletion: x1,onCancel: x2,onError: x3}),
      ...
      TH: x0 => x0.first(),
      TI: () => new AbortController(),
      TJ: (x0,x1,x2) => x0.setAttribute(x1,x2),
      TK: (x0,x1) => { x0.height = x1 },
      TL: (x0,x1,x2) => x0.createPayment(x1,x2),
      ...
      YK: x0 => x0.src,
      YL: x0 => globalThis.URL.createObjectURL(x0),
      YM: (x0,x1) => x0.removeItem(x1),
      YN: (x0,x1) => x0.querySelector(x1),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      bK: (x0,x1,x2,x3,x4) => globalThis.createImageBitmap(x0,x1,x2,x3,x4),
      bL: x0 => globalThis.URL.revokeObjectURL(x0),
      bM: (wasmFunction,f) => finalizeWrapper(f, function(x0) { return wasmFunction(f,arguments.length,x0) }),
      bN: x0 => x0.getReader(),
      c: o => o,
      cB: o => {
      ...
      dH: x0 => x0.done,
      dI: x0 => x0.getReader(),
      dJ: x0 => x0.fullscreenElement,
      dK: x0 => x0.naturalWidth,
      dL: (x0,x1) => { x0.currentTime = x1 },
      dM: (x0,x1) => x0.postMessage(x1),
      dN: x0 => x0.done,
      e: () => globalThis,
      eB: o => {
        if (o === null || o === undefined) return 0;
      ...
      eI: x0 => x0.read(),
      eJ: (x0,x1) => { x0.controls = x1 },
      eK: x0 => x0.decode(),
      eL: (x0,x1) => { x0.onseeked = x1 },
      eM: (x0,x1) => { x0.onmessage = x1 },
      eN: x0 => x0.read(),
      ...
      fI: x0 => x0.value,
      fJ: x0 => x0.play(),
      fK: (x0,x1) => { x0.decoding = x1 },
      fL: (x0,x1) => x0.getContext(x1),
      fM: (x0,x1) => x0.transferFromImageBitmap(x1),
      fN: x0 => x0.body,
      ...
      gI: x0 => x0.done,
      gJ: (x0,x1) => { x0.innerHTML = x1 },
      gK: (x0,x1) => { x0.crossOrigin = x1 },
      gL: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      gM: (x0,x1) => x0.getContext(x1),
      gN: (x0,x1) => new OffscreenCanvas(x0,x1),
      ...
      hI: x0 => x0.cancel(),
      hJ: x0 => x0.paused,
      hK: (x0,x1) => x0.createObjectURL(x1),
      hL: (x0,x1,x2) => x0.toDataURL(x1,x2),
      ...
      jH: x0 => x0.buffer,
      jI: x0 => x0.headers,
      jJ: (x0,x1) => { x0.bottom = x1 },
      jK: x0 => new Blob(x0),
      jL: x0 => x0.width,
      jM: x0 => x0.height,
      jN: () => globalThis._flutter,
      k: o => o,
      kB: o => {
        if (o === null || o === undefined) return 0;
      ...
      lL: x0 => x0.videoHeight,
      lM: x0 => x0.rasterEndMilliseconds,
      m: () => globalThis.Math,
      ...
      mJ: (x0,x1) => { x0.zIndex = x1 },
      mK: x0 => x0.name,
      mL: (x0,x1) => { x0.width = x1 },
      mM: x0 => x0.rasterStartMilliseconds,
      ...
      nI: (x0,x1,x2) => x0.authenticate(x1,x2),
      nJ: (x0,x1) => { x0.userSelect = x1 },
      nK: x0 => x0.repetitionCount,
      nL: x0 => x0.videoWidth,
      nM: x0 => x0.imageBitmaps,
      ...
      oI: x0 => x0.accessToken,
      oJ: (x0,x1) => { x0.border = x1 },
      oK: x0 => x0.frameCount,
      oL: x0 => x0.readyState,
      oM: x0 => x0.canvasKitMaximumSurfaces,
      p: b => !!b,
      ...
      pI: (o, t) => typeof o === t,
      pJ: (x0,x1) => { x0.borderRadius = x1 },
      pK: x0 => x0.selectedTrack,
      pL: x0 => x0.duration,
      pM: x0 => x0.nextSibling,
      ...
      qI: x0 => x0.user,
      qJ: (x0,x1) => { x0.justifyContent = x1 },
      qK: x0 => x0.completed,
      qL: (x0,x1) => { x0.onerror = x1 },
      ...
      rI: x0 => x0.network,
      rJ: (x0,x1) => { x0.alignItems = x1 },
      rK: x0 => x0.ready,
      rL: (x0,x1) => { x0.onloadeddata = x1 },
      ...
      tI: x0 => x0.transaction,
      tJ: (x0,x1) => { x0.onclick = x1 },
      tK: x0 => x0.close(),
      ...
      uI: x0 => x0.metadata,
      uJ: x0 => x0.pause(),
      uK: (x0,x1) => ({frameIndex: x0,completeFramesOnly: x1}),
      ...
      vK: (x0,x1) => x0.decode(x1),
      vL: (x0,x1) => x0.removeChild(x1),
      vM: x0 => x0.altKey,
      ...
      wI: x0 => x0.amount,
      wJ: (x0,x1) => { x0.inset = x1 },
      wK: x0 => x0.displayHeight,
      wL: x0 => x0.click(),
      wM: x0 => x0.ctrlKey,
